...
CREATE OR REPLACE TRIGGER ts_TAR_PARAMETROS_TAR_PARAMETROS_SEQ01 BEFORE INSERT
...
END;
/
CREATE OR REPLACE TRIGGER tsu_TAR_PARAMETROS_TAR_PARAMETROS_SEQ01 AFTER UPDATE OF par_id
ON TAR_PARAMETROS FOR EACH ROW
BEGIN
...
CREATE OR REPLACE TRIGGER ts_TAR_USUARIO_TAR_USUARIO_SEQ01 BEFORE INSERT
...
END;
/
CREATE OR REPLACE TRIGGER tsu_TAR_USUARIO_TAR_USUARIO_SEQ01 AFTER UPDATE OF usu_id
ON TAR_USUARIO FOR EACH ROW
BEGIN
